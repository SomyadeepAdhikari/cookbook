import 'dart:convert';
import 'package:cookbook/widget/grid_recipe_card.dart';
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                  ...
                  hintStyle: const TextStyle(
                      color: Colors.black38, fontFamily: 'ArialRounded'),
          ...
          Expanded(
            child: Padding(
              ...
              child: RefreshIndicator(
                onRefresh: () async {
                  setState(() {
                    recipes = getSearchRecipe(textEditingController.text);
                  });
                },
                child: FutureBuilder(
                    future: recipes,
                      ...
                      return GridView.builder(
                        ...
                        gridDelegate:
                            const SliverGridDelegateWithFixedCrossAxisCount(
                                crossAxisCount: 2, childAspectRatio: 0.975),
